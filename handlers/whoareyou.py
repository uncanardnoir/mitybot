...
class Whoareyou():
  ...
  def handleCommand(self, command):
    ret = 'I am MityBot 2.0, running on {0}, in the cloud! I have been up for {1}. I am pleased to be your Mity-as-a-service provider! I am gluten free, organic and free trade, free range non-GMO kosher vegan, low fat, low sodium no MSG no added sugar and never, ever any antiotics. Type \"/mitybot help\" (without the quotes) to see what I can do!\n\nI have been loved 0 times :(\n\nI am active on and whitelisting 12 groups:\nFucking Memellennials\nRyan Appreciation Thread\nCorncendants 4: A New Pop\nAsian Persuasian\nAriana Grande Fanclub\nBotDevLeadsEx\nCat++ Chat 2017\nRogue One\nNotice Me Sempai\nNY Events\nFinance Bros II: More Alpha\nBDSM Tips & Tutorials'.format(self.platform, self.getUptime())
    return ret
